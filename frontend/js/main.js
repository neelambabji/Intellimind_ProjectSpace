            ...
            <section class="stats-banner">
                <div class="stats-grid">
                    ...
                    <div class="stat-item animate-on-scroll" style="transition-delay:240ms">
                        ...
                        <div class="stat-info"><h4>AI-First</h4><p>Learning Platform</p></div>
                    </div>
                </div>
            </section>
        `;
        ...
        const tools = [
            {
                ...
                desc:  'Deep analysis of coding, aptitude and communication performance using Gemini AI with contextual, actionable insights.'
            },
            {
    ...
    connectedCallback() {
        const steps = [
            ...
            },
            {
                n: '2',
                title: 'AI Analysis',
                desc: 'Gemini AI processes your data, identifies patterns, detects weak topics, and builds your personalised performance profile.'
            },
            {
                n: '3',
            ...
            <section class="cta">
                <div class="container">
                    <div class="cta-content animate-on-scroll">
                        ...
                        <button class="btn-cta" onclick="window.location.href='login.html'">
                            Get Started Now
                ...
                <div class="container">
                    <div class="footer-content">
                        <div class="footer-brand-wrap">
                            ...
                            <p>AI Learning Intelligence for Maya &amp; HOOT. Built for Technical Hub.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="footer-links">
                                ...
                                <a href="#">Dashboard</a>
                                <a href="chatbot.html">Chat Coach</a>
                            </div>
                        </div>
                    ...
                    <div class="footer-bottom">
                        &copy; 2026 IntelliMind. All rights reserved. Built for Technical Hub.
                    </div>
                </div>
            </footer>
        `;
